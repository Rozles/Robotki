...
echo_and_run cd " ~/Documents/FRI/3-letnik/RINS/DN3/Robotki/workspace/src/yujin_ocs/yocs_navigator"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    " ~/Documents/FRI/3-letnik/RINS/DN3/Robotki/workspace/src/yujin_ocs/yocs_navigator/setup.py" \
     \
    build --build-base " ~/Documents/FRI/3-letnik/RINS/DN3/Robotki/workspace/build/yujin_ocs/yocs_navigator" \
    install \
    --root="${DESTDIR-/}" \
