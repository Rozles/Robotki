...
echo_and_run cd " ~/Documents/FRI/3-letnik/RINS/DN3/Robotki/workspace/src/kobuki_desktop/kobuki_dashboard"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    " ~/Documents/FRI/3-letnik/RINS/DN3/Robotki/workspace/src/kobuki_desktop/kobuki_dashboard/setup.py" \
     \
    build --build-base " ~/Documents/FRI/3-letnik/RINS/DN3/Robotki/workspace/build/kobuki_desktop/kobuki_dashboard" \
    install \
    --root="${DESTDIR-/}" \
